...
1. Check existing [issues](https://github.com/musictechlab/mtl-scrapmeup/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-scrapmeup/discussions)
